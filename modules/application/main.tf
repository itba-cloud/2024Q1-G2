...
data "archive_file" "tweets_raw" {
  type        = "zip"
  source_file = "./static/lambdas/tweets_raw.py"
  output_path = "./static/lambdas/tweets_raw.zip"
}
resource "aws_lambda_function" "tweets_raw" {
  filename      = "./static/lambdas/tweets_raw.zip"
...
data "archive_file" "consult_db" {
  type        = "zip"
  source_file = "./static/lambdas/consult_db.py"
  output_path = "./static/lambdas/consult_db.zip"
}
resource "aws_lambda_function" "consult_db" {
  filename      = "./static/lambdas/consult_db.zip"
...
data "archive_file" "add_tweet" {
  type        = "zip"
  source_file = "./static/lambdas/add_tweet.py"
  output_path = "./static/lambdas/add_tweet.zip"
}
resource "aws_lambda_function" "add_tweet" {
  filename      = "./static/lambdas/add_tweet.zip"
...
data "archive_file" "update_db" {
  type        = "zip"
  source_file = "./static/lambdas/update_db.py"
  output_path = "./static/lambdas/update_db.zip"
}
resource "aws_lambda_function" "update_db" {
  filename      = "./static/lambdas/update_db.zip"
